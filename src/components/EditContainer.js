  ...
  return (
    <React.Fragment>
      <form className="markdown-form" onSubmit={(event) => { event.preventDefault(); }}>
        <textarea className="markdown-input" onChange={(event) => handleChange(event)} value={markdownInput} rows="20" placeholder="Enter GitHub Flavored Markdown syntax to preview..." aria-label="Enter GitHub Flavored Markdown syntax to preview" id="markdown-code" autoComplete="off" />
      </form>
