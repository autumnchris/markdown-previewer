  ...
  return (
    <React.Fragment>
      ...
      <div className="button-group">
        <button type="button" className="button" onClick={() => copyText(markdownInput)}><span className="fa-regular fa-copy fa-fw" aria-hidden="true"></span> Copy to Clipboard</button>
      </div>
    </React.Fragment>
  );
}
