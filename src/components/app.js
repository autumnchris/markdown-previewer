  ...
  render() {
    ...
    return (
      <div className="container-fluid">
        ...
        {/* FOOTER */}
        <footer className="text-center">Created by <a href="https://autumnbullard-portfolio.herokuapp.com" target="_blank">Autumn Bullard</a> &copy; {new Date().getFullYear()}</footer>
      </div>
    );
  }
}
